...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Text to Speech', href: zonos.tts.url() },
];
...
export default function ZonosTTSPage({ languages, runpod_health, initial_process_status }: Props) {
    ...
    const handleSubmit = (e: React.SyntheticEvent<HTMLFormElement>) => {
        e.preventDefault();
        post(zonos.tts.store.url(), { preserveScroll: true });
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Zonos TTS" />
            <div className="flex flex-col gap-6 p-4 md:p-6 max-w-2xl">
                <div>
                    <h1 className="text-2xl font-bold">Text to Speech</h1>
                    <p className="text-muted-foreground">Generate speech from text using Zonos.</p>
                </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Select a language, enter your text, and adjust voice settings.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                            ...
                            <Button type="submit" disabled={processing || !data.language || !data.text}>
